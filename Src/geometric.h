...
extern void point_transform( float *, float *, Transf_mat const * );
extern void mat_to_array( Transf_mat const *, float [16] );
extern void array_to_mat( float const [16], Transf_mat * );
