...
\n# and is for use by the griz team. Do not modify or alter in any way.\n";
    ...
    for ( i = 0; i < analy->mesh_qty; i++ )
    {
        ...
        p_md->particle_qty = 0;  /* Force particle allocation for now since we
...
//    }
    ...
    if(analy->mat_labels_active && env.ti_enable){
    	...
    	//predefined names
    	char *tempnames[16] = {"vis","invis","enable","disable","include",
                             "exclude","hilite","select","mat","all",
                             "amb","diff","spec","spotdir","spot","exp"};
    	int tempcount = 16;
    	int tmppos = 0;
